...
import { configService, documentService, supplierService } from "@/lib/services";
import type { DocumentSection } from "@/types";

const SECTION_META: Record<DocumentSection, { title: string; description: string }> = {
  MANDATORY: {
    title: "Mandatory Documents",
    description: "Required to complete your registration.",
  },
  AVL_EVALUATION: {
...
export default function DocumentsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Documents"
        description="Upload and manage your qualification documents. Expiring items are flagged 90 days ahead."
      />
