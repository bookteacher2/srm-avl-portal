...
export default function AdminSuppliersPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Supplier Master" description="The full supplier master directory. AVL-active suppliers are eligible for RFQ and projects." />
      <Card>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>RFQ Eligible</TableHead>
                  <TableHead className="text-right">Score</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {rows.map((s) => {
                  // Eligible for RFQ / projects once active on the AVL.
                  const rfqEligible = s.avlStatus === "ACTIVE" || s.avlStatus === "CONDITIONAL";
                  return (
                    <TableRow key={s.id}>
                      ...
                      <TableCell>
                        <Badge variant={rfqEligible ? "success" : "muted"}>{rfqEligible ? "Eligible" : "—"}</Badge>
                      </TableCell>
