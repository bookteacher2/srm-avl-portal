...
export interface Application extends AuditFields {
  id: ID; // Application ID (created at registration, alongside the Supplier)
  referenceCode: string; // public tracking code, e.g. "APP-2026-0142"
  supplierId: ID;
  cycle: ApplicationCycle;
  currentStage: ApplicationStage;
  status: ApplicationStatus;
  decisionOutcome?: DecisionOutcome; // set at the DECISION stage
